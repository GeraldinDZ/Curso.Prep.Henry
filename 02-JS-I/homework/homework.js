...
function agregarSimboloExclamacion(str) {
  ...
  // Tu código:
  var agregarSimboloExclamacion = ("Hola")
  return str + "!"
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  var combinarNombres = 'Geraldin , Doria'
